    ...
    <main className="min-h-screen w-full bg-black text-white selection:bg-[#EC612C] selection:text-white relative">
      ...
      <aside aria-label="Quick launch assistant" className="fixed bottom-6 right-6 z-30 flex items-center gap-2">
        <button
          ...
          className="group flex items-center gap-2.5 px-4 py-3 rounded-full bg-gradient-to-r from-[#EC612C] to-[#ff7d4d] text-white font-semibold text-xs md:text-sm shadow-[0_8px_30px_rgb(236,97,44,0.4)] hover:shadow-[0_8px_35px_rgb(236,97,44,0.6)] hover:scale-105 active:scale-95 transition-all"
